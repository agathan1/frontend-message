      ...
      <div>
        ...
        <div className=" mt-22">
          <section className="space-y-8 text-secondary justify-center flex flex-col font-poppins font-medium">
            <p className="text-center text-black">Berikut isi pesan dari si pengirim:</p>
            <p className="max-w-[70%] mx-auto text-center font-satisfy text-6xl">
        ...
        <div className="mt-22">
          <section className="space-y-8 text-black justify-center flex flex-col font-poppins font-medium">
            <p className="text-center">Terima kasih telah membaca pesan ini.</p>
